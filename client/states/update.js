export default Client => function () {
  ...
  if ((this.currentPlayer && this.currentPlayer.targetLocked) || (this.currentPlayer && this.currentPlayer.children.find(item => item.isBlock)) ) {
    playerSpeed = 0.70 * playerSpeed
  }
